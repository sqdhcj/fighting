        ...
        requirejs(
            ...
            function ($){
                ...
                $('#tb_Company').bootstrapTable({
                    ...
                    columns: [{
                        ...
                        formatter: function indexFormatter(value, row, index){
                            var newvalue="";
                            if(value == "正常经营"){newvalue= '<span class="badge badge-success">'+value+'</span>';}
                            else if(value == "经营异常"){newvalue= '<span class="badge badge-warning">'+value+'</span>';}
                ...
                $("#btn_add").on('click',function (){
                    layer.open({
                        type: 2, //表示用iframe层
                        skin: 'layui-layer-molv',//内置样式皮肤层
                        title: '新增公司',
                        shadeClose: true,//背景是否有阴影
                        shade: 0.4,//阴影程度
                        maxmin:false,//是否全屏
                        area:['800px','800px'],
                        content:'/CompanyModule/addCompanyHtml',//指向控制层方法
                        end:function (){
                            $('#tb_Company').bootstrapTable('refresh');//关闭进行刷新
                        }
                    });
                });
